...
public class Dialogue : MonoBehaviour
{
    ...
    void Start()
    {
        string[] start_script = {"Rise and shine citizen..... due to your <color=red>UNPAID BALANCE<color=white> of 2000 units you have been reassigned to <color=red>KITCHEN DUTY<color=white> until your debt with <color=#ADD8E6>CompanyIncorperated™<color=white> is settled",
        ...
        dialogues.Add("start day2", start_day2);
